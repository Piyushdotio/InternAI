...
import { Sparkles, ArrowLeft, ArrowRight, Lock, Mail, User } from 'lucide-react';
...
const Page = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f5f1e4] text-[#2c2e2a] font-sans flex flex-col items-center justify-center p-6 md:p-12 relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-10 right-10 w-24 h-24 rounded-[30px] border-2 border-[#2c2e2a]/5 bg-white/20 transform -rotate-12 pointer-events-none"></div>
            <div className="absolute bottom-10 left-10 w-32 h-32 rounded-full border-2 border-[#2c2e2a]/5 bg-white/20 pointer-events-none"></div>
            ...
            <div className="w-full max-w-[500px] bg-white border-2 border-[#2c2e2a] rounded-[50px] p-8 md:p-10 shadow-sm relative z-10 space-y-6">
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                    {/* SVG Greeting Sparkle Card */}
                    <div className="w-16 h-16 bg-[#ff705d] border-2 border-[#2c2e2a] rounded-full flex items-center justify-center overflow-hidden">
                        <svg className="w-9 h-9 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 3C7.03 3 3 7.03 3 12C3 16.97 7.03 21 12 21C16.97 21 21 16.97 21 12C21 7.03 16.97 3 12 3ZM12 6C13.66 6 15 7.34 15 9C15 10.66 13.66 12 12 12C10.34 12 9 10.66 9 9C9 7.34 10.34 6 12 6ZM12 18.2C9.39 18.2 7.07 16.88 5.75 14.88C5.78 12.87 9.79 11.75 12 11.75C14.2 11.75 18.21 12.87 18.25 14.88C16.93 16.88 14.61 18.2 12 18.2Z" fill="currentColor"/>
                        </svg>
                    </div>
                    
                    <div className="space-y-1">
                        <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#ff705d]/10 text-[#ff705d] border border-[#ff705d]/20 rounded-full text-[10px] font-bold uppercase tracking-wider">
                            Free Registration
                        </span>
                        <h2 className="text-2xl md:text-3xl font-extrabold text-[#2c2e2a] tracking-tight">Create Account</h2>
                        <p className="text-xs text-[#80827f] font-semibold">Join the platform to begin practicing AI interviews</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="username" className="block text-[10px] font-bold uppercase tracking-wider text-[#2c2e2a]">
                            Username
                        </label>
                    ...
                    <button 
                        type="submit" 
                        disabled={isLoading}
                        className="w-full mt-4 py-3.5 px-4 bg-[#ff705d] hover:bg-[#ff705d]/90 disabled:opacity-50 text-[#2c2e2a] border-2 border-[#2c2e2a] text-sm font-bold rounded-[50px] transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
                        {isLoading ? (
                            <>
                ...
                <div className="text-center text-xs font-semibold text-[#80827f] pt-4 border-t border-[#2c2e2a]/10 flex items-center justify-center gap-1.5">
                    ...
                    <Link href="/login" className="text-[#ff705d] hover:underline font-bold">
                        Sign In
                    </Link>
                </div>
